export const homeObjOne = {
  ...
  imgStart: false,
  img: require("../../assets/imgs/svg-1.svg").default,
  alt: "Car",
  dark: true,
  primary: true,
  darkText: false,
...
export const homeObjTwo = {
  ...
  imgStart: true,
  img: require("../../assets/imgs/svg-3.svg").default,
  alt: "bank",
  dark: false,
  primary: false,
  darkText: true,
...
export const homeObjThree = {
  ...
  description:
    "Get everything setup in 10 minutes.All you need to do is your information and you're ready to go",
  buttonLabel: "Start Now",
  imgStart: false,
  img: require("../../assets/imgs/svg-5.svg").default,
  alt: "join",
  dark: false,
  primary: false,
  darkText: true,
